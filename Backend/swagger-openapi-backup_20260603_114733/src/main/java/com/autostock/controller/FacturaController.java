...
public class FacturaController {
    ...
    public ResponseEntity<FacturaDTO> generarFacturaCompra(@RequestBody FacturaDTO facturaDTO) {
        Factura factura = toEntity(facturaDTO);
    ...
    public ResponseEntity<FacturaDTO> generarFacturaVenta(@RequestBody FacturaDTO facturaDTO) {
        Factura factura = toEntity(facturaDTO);
