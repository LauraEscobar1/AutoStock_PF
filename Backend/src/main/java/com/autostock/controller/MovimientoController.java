...
public class MovimientoController {
    ...
    public ResponseEntity<MovimientoDTO> guardar(@Valid @RequestBody MovimientoDTO dto) {
    ...
    public ResponseEntity<MovimientoDTO> registrarEntrada(@Valid @RequestBody MovimientoDTO dto) {
    ...
    public ResponseEntity<MovimientoDTO> registrarSalida(@Valid @RequestBody MovimientoDTO dto) {
    ...
    public ResponseEntity<MovimientoDTO> registrarDevolucion(@Valid @RequestBody MovimientoDTO dto) {
